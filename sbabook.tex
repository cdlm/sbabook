...
Open Sans for structural text
Gentium for paragraphs
Inconsolata for code, no syntax highlighting
...
\begin{listing}[%
  title={Listing~\thetcbcounter~--- The constructor of class \code|Foo|},
  label=lst:fooNewWith,
  coltitle=black,
  attach boxed title to top left={xshift=-2cm},
  boxed title style={empty,colback=yellow},
]{Smalltalk}
